// Example usage:
// SurgeryUI.visit()
// SurgeryUI.verify.hero()
// SurgeryUI.verify.otherServices()
// SurgeryUI.nav.otherServices.petUltrasound().click()
// SurgeryUI.nav.scheduleAppointment().click()

class SurgeryUI {
  visit() {
    cy.visit('/services/pet-general-surgery')
  }
