// Example usage:
// MedicalStaffUI.visit()
// MedicalStaffUI.verify.header()
// MedicalStaffUI.verify.staffCards()
// MedicalStaffUI.nav.clickByName('Nicole Nelson')

class MedicalStaffUI {
  visit() {
    cy.visit('/staff/medical-staff')
  }
...
export default new MedicalStaffUI()